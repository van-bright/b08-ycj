...
function step1_transfer_bnb(fromPrivKey, toPubKey, bnbAmount) {
    return __awaiter(this, void 0, void 0, function* () {
    });
}
const MNMContract = '0xF24Bf668Aa087990f1d40aBAbF841456E771913c';
function step2_withdraw_metamon() {
    return __awaiter(this, void 0, void 0, function* () {
        const method = 'withdraw721ByIds(address,uint256[],string)';
        const stringparma = '1473213493641481216';
    });
}
function step3_transfer_metamon() {
    return __awaiter(this, void 0, void 0, function* () {
        const method = 'safeTransferFrom(address from, address to, uint256 tokenId)';
    });
}
function main() {
    return __awaiter(this, void 0, void 0, function* () {
...
main();
//# sourceMappingURL=duohui.js.map